---
title: "PAAS Week 10: Visualizing data"
subtitle: "Week 10 Tutorial"
description: "Psychology as a Science Week 10 Tutorial. Do this tutorial to prepare for the Week 11 practical class."
author: "Andy Field"
output:
  learnr::tutorial
...
bug <- function(fill = "warning", height = 1){
...
cat_space <- function(fill = "tip", height = 1.5){
...
robot <- function(fill = "default", height = 1){
...
bmu <- function(fill = "default", height = 1){
...
user_astronaut <- function(fill = "default", height = 1){
...
user_visor <- function(fill = "default", height = 1){
...
wish_tib <- paas::jiminy_cricket
notebook_tib <- paas::notebook
exam_tib <- paas::exam_anxiety
```
...
This tutorial is from the `discovr` developed by Prof Andy Field. You can find
more on the [`discovr` website](https://www.discovr.rocks/).
...
Set up an `r rstudio()` project in the way that [I recommend in this
tutorial](http://milton-the-cat.rocks/learnr/r/r_getting_started/#section-working-in-rstudio),
and save the data files to the folder within your project called [data]{.alt}.
Place this code in the first code chunk in your `r rproj()` Markdown document:
...
To work *outside of this tutorial* you need to turn categorical variables into
factors and set an appropriate baseline category using `forcats::as_factor` and
`forcats::fct_relevel`.
